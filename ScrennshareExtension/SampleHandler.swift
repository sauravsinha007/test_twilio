...
class SampleHandler: RPBroadcastSampleHandler {
    ...
    override func broadcastStarted(withSetupInfo setupInfo: [String : NSObject]?) {
        print("broadcastStarted setupInfo = \(String(describing: setupInfo))")
        ...
        print("SampleHandler-Debug accessToken = \(accessToken)")
        ...
        let connectOptions = ConnectOptions(token: accessToken) { (builder) in
            print("SampleHandler-Debug  connectOptions = \((builder))")
           ...
           // builder.audioTracks = [self.audioTrack!]
            ...
            builder.roomName = SampleHandler.kBroadcastSetupInfoRoomNameKey
            //setupInfo?[SampleHandler.kBroadcastSetupInfoRoomNameKey] as? String
        }
        print("SampleHandler-Debug  connectOptions before room connect = \((connectOptions))")
        // Connect to the Room using the options we provided.
        room = TwilioVideoSDK.connect(options: connectOptions, delegate: self)

        print("SampleHandler-Debug  connectOptions after room connect = \(String(describing: (room)))")
...
extension SampleHandler : RoomDelegate {
    func roomDidConnect(room: Room) {
        print("didConnectToRoom: , \(room) --- room.name = \(room.name)")
